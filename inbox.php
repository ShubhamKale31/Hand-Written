...
echo "<div style='margin-left:10px;width:640px;height:auto;border:2px solid red;' align='center'>";

	echo "<table align='center' border='1' width='640' >";
...
while(list($mid,$rid,$sid,$s,$m,$a,$d)=mysqli_fetch_array($dd))
{
	...
	echo "<td>".$sid."</td>";
	echo "<td><a href='home.php?coninb=$mid'>".$s."</a></td>";
	echo "<td>".$d."</td>";
	echo "</tr>";	
	}
	echo "</table>";
